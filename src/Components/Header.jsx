...
import pokemonImg2 from "../img/pokemon-logo.webp"
import pokemonImg3 from "../img/pokemon-picatchu.png"
...
export default function Header() {
  ...
  return (
    <div className="flex flex-row items-center justify-between">
        ...
        <img className="h-32 w-48" src={pokemonImg2} alt="" />
        <img className="h-28 w-44 -ml-8" src={pokemonImg3} alt="" />
        </div>
